...
├── ava_chatbot_backend_service             # The main python package for the project
...
e.g: `cat ava_chatbot_backend_service/VERSION` will get the project version without harming
